...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/comfort">Комфорт<span class="sr-only"></span></a></li>
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="comfort" action="/admin/comfort" method="post">
	   			   <div class="form-group">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${comfort.id != null}">
	   							<a href="/admin/comfort/cancel/${comfort.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
		  ...
		  <div class="col-sm-10 col-sm-offset-1">
			<table class="table table-bordered">
				...
				<c:forEach items="${comforts}" var="comfort">
				  <tr>
					<td>${comfort.name}</td>
					<td class="text-center"><a href="/admin/comfort/update/${comfort.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/comfort/delete/${comfort.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
