...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/model">Модель<span class="sr-only"></span></a></li>
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="model" action="/admin/model" method="post">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${model.id != null}">
	   							<a href="/admin/model/cancel/${model.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
			...
			<table class="table table-bordered">
				...
				<c:forEach items="${models}" var="model">
				  <tr>
					...
					<td class="text-center"><a href="/admin/model/update/${model.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/model/delete/${model.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
