...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/gearbox">Коробка передач<span class="sr-only"></span></a></li>
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="gearbox" action="/admin/gearbox" method="post">
	   			   <div class="form-group">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${gearbox.id != null}">
	   							<a href="/admin/gearbox/cancel/${gearbox.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
		  ...
		  <div class="col-sm-10 col-sm-offset-1">
			<table class="table table-bordered">
				...
				<c:forEach items="${gearboxes}" var="gearbox">
				  <tr>
					<td>${gearbox.name}</td>
					<td class="text-center"><a href="/admin/gearbox/update/${gearbox.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/gearbox/delete/${gearbox.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
