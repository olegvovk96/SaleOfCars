...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/city">Місто<span class="sr-only"></span></a></li>							
						</ul> 				
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="city" action="/admin/city" method="post">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${city.id != null}">
	   							<a href="/admin/city/cancel/${city.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
			...
			<table class="table table-bordered">
				...
				<c:forEach items="${cities}" var="city">
				  <tr>
					...
					<td class="text-center"><a href="/admin/city/update/${city.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/city/delete/${city.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
