...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							<li class="active"><a href="/admin/mark">Марка<span class="sr-only"></span></a></li>
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="mark" action="/admin/mark" method="post">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${mark.id != null}">
	   							<a href="/admin/mark/cancel/${mark.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
		  ...
		  <div class="col-sm-10 col-sm-offset-1">
			<table class="table table-bordered">
				...
				<c:forEach items="${marks}" var="mark">
				  <tr>
					<td>${mark.name}</td>
					<td class="text-center"><a href="/admin/mark/update/${mark.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/mark/delete/${mark.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
