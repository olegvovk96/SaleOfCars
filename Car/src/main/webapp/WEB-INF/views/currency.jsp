...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">					
						 <ul class="nav navbar-nav">
							...
							<li class="active"><a href="/admin/currency">Валюта<span class="sr-only"></span></a></li>
							<li><a href="/admin/region">Область</a></li>
	...
	<div class="container">
	   <div class="row">
	   		<div class="col-sm-12">
	   			<form:form class="form-horizontal" modelAttribute="currency" action="/admin/currency" method="post">
	   			   <div class="form-group">
	   				...
	   				<div class="form-group">
	   					<div class="col-sm-10 col-sm-offset-2">
	   						...
	   						<c:if test="${currency.id != null}">
	   							<a href="/admin/currency/cancel/${currency.id}" class="btn btn-danger decorationCancel">Cancel</a>
	   						</c:if>
	   					</div>
	   				</div>
	   			</form:form>
		  ...
		  <div class="col-sm-10 col-sm-offset-1">
			<table class="table table-bordered">
				...
				<c:forEach items="${currencies}" var="currency">
				  <tr>
					<td>${currency.name}</td>
					<td class="text-center"><a href="/admin/currency/update/${currency.id}" class="btn btn-warning">Update</a></td>
					<td class="text-center"><a href="/admin/currency/delete/${currency.id}" class="btn btn-danger">Delete</a></td>
				  </tr>
				</c:forEach>
			</table>
		   </div>
